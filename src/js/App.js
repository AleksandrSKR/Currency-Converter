          ...
          <div className="row">
            <div className="col-sm-6 currency-from-input">
              ...
              <div className="input-group">
                ...
                <input type="number" value={currencyAval} className="form-control" aria-describedby="basic-addon2" step="1" pattern="\d\.\d{2}" onChange={(e) => {this.onChangeHandler(e , 'A')}} />
            ...
            <div className="col-sm-6 currency-to-input">
              ...
              <div className="input-group">
                ...
                <input type="number" value={currencyBval} className="form-control" aria-describedby="basic-addon3" step="1" pattern="\d\.\d{2}" onChange={(e) => {this.onChangeHandler(e, 'B')}} />
